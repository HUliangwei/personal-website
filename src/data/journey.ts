  ...
  zh: [
    {
      ...
      detail: '物理训练提供了理解约束和建模的方法；电路、数字逻辑与计算课程则把这种理解推向可实现的硬件系统。',
      motif: 'physics',
      evidence: 'Official',
    },
    {
  ...
  en: [
    {
      ...
      detail: 'Physics developed a way to reason from constraints and models; coursework in circuits, digital logic, and computation connected that reasoning to implementable hardware systems.',
      motif: 'physics',
      evidence: 'Official',
    },
    {
