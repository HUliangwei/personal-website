...
test('Phase 1 foundation renders accessible global layout contracts', () => {
  ...
  assert.match(home, /<link rel="canonical" href="https:\/\/personal-website\.huliangwei020311\.workers\.dev\/en"/);
  ...
  assert.match(home, /<a[^>]*href="\/en"[^>]*aria-current="page"/);
  assert.match(home, /href="https:\/\/github\.com\/HUliangwei\/personal-website"/);
  assert.match(about, /<a[^>]*href="\/en\/about"[^>]*aria-current="page"/);
});
